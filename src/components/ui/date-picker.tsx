...
function getDateTimeFormat(
  ...
  switch (granularity) {
    case "second":
      time = is12Hour ? " HH:mm:ss" : " hh:mm:ss b";
      break;
    case "minute":
      time = is12Hour ? " HH:mm" : " hh:mm b";
      break;
    case "hour":
      time = is12Hour ? " HH" : " hh b";
      break;
  }

  return is12Hour ? "PPP" + time : "PP" + time;
}
...
>(
  (
    ...
    const timeFormat = displayFormat ?? getDateTimeFormat(granularity, hourCycle);

    return (
      <Popover>
        <PopoverTrigger asChild disabled={disabledTrigger}>
          <Button
            variant="outline"
            className={cn(
