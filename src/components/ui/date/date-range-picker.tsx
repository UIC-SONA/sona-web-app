...
interface DateRangePickerProps<T extends DateValue> extends ComponentProps<typeof DateRangePickerComponent<T>> {
}

export default function DateRangePicker<T extends DateValue>({...props}: DateRangePickerProps<T>) {
  const now = today(getLocalTimeZone());
  return (
    <Popover modal>
      <DateRangePickerComponent<T>
        className="space-y-2"
